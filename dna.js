    ...
    if (manejo === "hospitalario") {
      ...
      if (!isNaN(glucometriaValor)) {
          if (glucometriaValor < 54) {
              ...
              let planDetallado = "";
              if (concienciaAlterada) {
                  planDetallado = `    - Administrar un bolo de DAD 10 %, a razón de 5 ml/kg por SNG o vía endovenosa en cinco minutos.\n    - Repetir la glucometria a los 15 minutos si se administró endovenosa, o a los 30 minutos si se administró por vía enteral.\n    - Si persiste hipoglicemia, repetir el bolo de DAD 10 % de 5 ml/kg.\n    - Repetir la glucometría.\n    - Si hay mejoría, continuar con F-75 por SNG cada 30 minutos, a razón de 3 ml/kg/toma, durante 2 horas.\n    - Repetir la glucometría cada hora.\n    - Si persiste la hipoglicemia, presenta hipotermia o el nivel de consciencia se deteriora, continuar con manejo individualizado y descartar patologías infecciosas.`;
              } else {
                  planDetallado = `    - Administrar un bolo de DAD 10 %, a razón de 5 ml/kg/dosis por vía oral o por SNG.\n    - Tomar una glucometria a los 30 minutos.\n    - Si persiste la hipoglicemia, repetir el bolo de DAD10 % de 5 ml/kg.\n    - Si hay mejoría, continuar con F-75, a razón de 3 ml/kg/toma cada 30 minutos durante 2 horas por vía oral o por SNG.`;
              }
              planHipoglicemia = resumen + planDetallado;
          } else {
              planHipoglicemia = `B - Glucosa ${glucometriaValor} mg/dl (Normal), continuar vigilancia cada 4 horas y alertar si hay alteración de conciencia.`;
          }
      }
